    ...
    class climate:
        ...
        class resolutions:
            ...
            class hourly:
                ...
                """
                pressure = (
                    ("QN_8", "int"),  # Quality level
                    ("P", "real"),           # Mean sea level pressure
                    ("P0", "real"),       # Pressure at station height
                )
                ...
                moisture = (
                    ("P_STD", "real"),  # Quality level
                    ("RF_STD", "real"),  # Mean wind speed
                    ("TT_STD", "real"),  # Mean wind direction
                )
        ...
        def get_resolutions(cls):
            ...
            for name, class_ in list(resolutions.items()):
